// Filename: SimpleQADashboard.jsx
// Author: Naitik Maisuriya
// Description: QA dashboard for reviewing team tasks
...
const SimpleQADashboard = () => {
  ...
  const fetchTasks = async () => {
    try {
      setLoading(true);
      const response = await userAPI.getQATasks();
      if (response.success) {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-1">View tasks assigned to employees under your supervision</p>
      </div>
